...
{
     GdkPixbuf *pixbuf = gdk_pixbuf_new_from_file("/usr/local/share/PMU/PmuLogo1.png",0);
...
//	g_free (markup);
	...
	image = gtk_image_new_from_file("/usr/local/share/PMU/PSLab.PNG");
	...
	image1 = gtk_image_new_from_file("/usr/local/share/PMU/PmuLogo.png");
...
void pmu_server ()
{
	...
	gtk_table_attach_defaults (GTK_TABLE (table), p_port, 1, 2, 2, 3);
...
void file_ok_sel(GtkWidget *w, GtkFileSelection *fs)
{
	...
	char *s = (char *)gtk_file_selection_get_filename (GTK_FILE_SELECTION (fs));
